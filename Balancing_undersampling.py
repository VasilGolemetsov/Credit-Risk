...
# Note that in this file we use balancing (undersampling) for our dataset.
# We see that the precision goes down, recall increases and the F-1 score is similar,
# compared to the example without balancing.
