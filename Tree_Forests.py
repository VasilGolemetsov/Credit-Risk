...
'''
The random forest model shows slightly better scores on precision,
recall and F1 compared to the decision tree. This indicates that the random forest
performs slightly better in classifying credit risk correctly.  
'''

'''
Precision Decision tree: 0.757847533632287 Precision Random Forest: 0.7777777777777778
Recall Decision Tree: 0.9548022598870056 Recall Random Forest: 0.9096045197740112
F1-Score Decision Tree: 0.845 Recall Random Forest: 0.8385416666666666
'''

'''
We also looked at oversampling and undersampling the data (see other files), 
however we see that this does not yield (much) better results. 
'''
...
'''
We have looked at accuracy, precision, recall, F1 score and the auc_roc score for random forest. 
'''